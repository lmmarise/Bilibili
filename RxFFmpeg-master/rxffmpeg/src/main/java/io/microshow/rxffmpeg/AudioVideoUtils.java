...
public class AudioVideoUtils {
    ...
    /**
     * 码率 = 文件大小(M) x 8 x 1024 / 时间
     * @param videoTimeSize     视频时长 s
     * @param videoFileSize     视频占用空间大小kb
     * return kbps
     */
    public static long getBitRate(int videoTimeSize, long videoFileSize) {
        return videoFileSize * 8 / videoTimeSize;
    }
...
//                Log.d(TAG, "Extractor selected track " + i + " (" + mime + "): " + format);
     ...
     * @return [0]视频  [1]音频
     */
    public static int[] getVideoAndAudioTrack(String videoUrl, String audioUrl) {
        ...
        try {
            ...
            track[0] = selectVideoTrack(videoExtractor);

            // 音频
            MediaExtractor audioExtractor = new MediaExtractor();
            audioExtractor.setDataSource(audioUrl);
            track[1] = selectAudioTrack(audioExtractor);
