 ...
 */
public abstract class BasePopupView extends FrameLayout implements OnNavigationBarListener, LifecycleObserver, Cloneable {
...
//            params.bottomMargin = isNavBarShown ? XPopupUtils.getPhoneScreenHeight(getContext()) - height : 0;
    ...
    @Override
    public BasePopupView clone() throws CloneNotSupportedException {
        return (BasePopupView) super.clone();
    }
}
